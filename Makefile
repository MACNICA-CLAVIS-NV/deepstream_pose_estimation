...
CFLAGS+= -I/opt/nvidia/deepstream/deepstream/sources/includes -I/opt/nvidia/deepstream/deepstream-5.1/sources/apps/apps-common/includes -I/opt/nvidia/deepstream/deepstream-5.1/sources/apps/sample_apps/deepstream-app -DDS_VERSION_MINOR=0 -DDS_VERSION_MAJOR=5
